...
def ssh_input(host, port, username, password, item):
    ...
    try:
        remote_command = _REMOTE_COMMAND % _SQL_COMMANDS[item]
...
def main():
    ...
    parser.add_argument("item", help="status item name",
                        choices=["instance", "tablespace"])
